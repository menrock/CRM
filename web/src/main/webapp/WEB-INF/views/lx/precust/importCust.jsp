...
<table>
	...
	<tr>
		<td style="text-align:right">资源来源</td>
		<td colspan='3'>
			<input type='text' name="stuFromName" style='width:220px' readonly>
			<a href='javascript:;' onclick='selStuFrom()'>...</a>
			<input type='hidden' id='stuFromId' name="stuFromId" >
		</td>
	</tr>
	<tr>
...
<div id='divFromTree' class="easyui-dialog" title="资源来源选择" data-options="closed:true" style="width:500px;height:360px;padding:10px">
