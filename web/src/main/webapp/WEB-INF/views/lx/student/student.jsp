...
<body id="mainLayout" class="easyui-layout" >
	<div data-options="region:'center'" style="overflow: hidden; ">
		<div id="mainTabs">
			<div title="学生信息" data-options="iconCls:'ext_house'">
				<iframe src="inquireRecord.do?id=${id}" allowTransparency="true" style="border: 0; width: 100%; height: 99%;" frameBorder="0"></iframe>
			</div>
		<c:if test="${null !=id}">
			<div title="邀约面访" data-options="iconCls:'ext_house'">
				<iframe src="/lx/visitInvite/stuList.do?stuId=${id}" allowTransparency="true" style="border: 0; width: 100%; height: 99%;" frameBorder="0"></iframe>
			</div>
			<div title="合同信息" data-options="iconCls:'ext_house'">
				<iframe src="/lx/contract/stuContracts.do?stuId=${id}" allowTransparency="true" style="border: 0; width: 100%; height: 99%;" frameBorder="0"></iframe>
			</div>
			<div title="付款信息" data-options="iconCls:'ext_house'">
				<iframe src="/payment/stuPayments.do?stuId=${id}" allowTransparency="true" style="border: 0; width: 100%; height: 99%;" frameBorder="0"></iframe>
			</div>
			<div title="附件信息" data-options="iconCls:'ext_house'">
				<iframe src="/cust/attach/listByCust.do?id=${id}&bizType=LX" allowTransparency="true" style="border: 0; width: 100%; height: 99%;" frameBorder="0"></iframe>
			</div>
			<div title="录取签证附件" data-options="iconCls:'ext_house'">
				<iframe src="/lx/offerVisa/resultAttach/list.do?id=${id}" allowTransparency="true" style="border: 0; width: 100%; height: 99%;" frameBorder="0"></iframe>				
			</div>
			<div title="宣传配合附件" data-options="iconCls:'ext_house'">
				<iframe src="/lx/contract/xcclAttach/list.do?id=${id}" allowTransparency="true" style="border: 0; width: 100%; height: 99%;" frameBorder="0"></iframe>
			</div>
		</c:if>
		</div>
	</div>  		
