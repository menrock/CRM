...
<link rel="stylesheet" type="text/css" href="/_resources/easyui/themes/default/easyui.css">
	...
	$(function() {
	  ...
	  grid = $('#grid').datagrid({
				title : '',
				url : '/lx/student/listYoungData.do',
				striped:true,
				rownumbers : true,
				pagination : true,
				pageSize : 15,
...
<table width=800px>
  ...
  <tr><td width=100% align='center' height=30 class='title'>低龄客户</td></tr>
</table>
	...
	<table width="100%" border="0">
		...
		<tr>
			...
			<td colspan='3'>
				<select id="stu_level" name="stu_level" class="easyui-combotree" panelWidth="450" style="width:400px;" multiple="multiple"></select>
			</td>
