...
public class LxCustomer extends BaseModel{
	private static final long serialVersionUID = 324093640546703976L;
	...
	private Date kfLastContactDate;     //客服最近联系时间
	private Date gwLastContactDate;     //顾问最近联系时间
	private Date leaderLastContactDate; //组长最近联系时间
	...
	private String oldDepart;  //销售易-归属部门
	private String oldCreator;  //销售易-创建人
	private String oldLevel;  //销售易-顾问评级
	private String oldStuFrom1;  //销售易-资源来源
	private String oldStuFrom2;  //销售易-来源媒介
	private String oldStatus;    //销售易中的 学生状态
	...
	public Date getKfLastContactDate() {
		return kfLastContactDate;
	}
	public void setKfLastContactDate(Date kfLastContactDate) {
		this.kfLastContactDate = kfLastContactDate;
	}
	
	public Date getGwLastContactDate() {
		return gwLastContactDate;
	}
	public void setGwLastContactDate(Date gwLastContactDate) {
		this.gwLastContactDate = gwLastContactDate;
	}
	
	public Date getLeaderLastContactDate() {
		return leaderLastContactDate;
	}
	public void setLeaderLastContactDate(Date leaderLastContactDate) {
		this.leaderLastContactDate = leaderLastContactDate;
	}
	...
	public String getOldStuFrom1() {
		return oldStuFrom1;
	}
	public void setOldStuFrom1(String oldStuFrom1) {
		this.oldStuFrom1 = oldStuFrom1;
	}

	public String getOldStuFrom2() {
		return oldStuFrom2;
	}
	public void setOldStuFrom2(String oldStuFrom2) {
		this.oldStuFrom2 = oldStuFrom2;
	}
	...
	public void setOldCreator(String oldCreator) {
		this.oldCreator = oldCreator;
	}
